...
.then(data => {
    if (data.online == true) {
        ...
        {% else %}
        document.getElementById("serverStatus").innerHTML = `<p class="font-bold select-none"><span class="text-green-600">&#11044;</span>&emsp;Juega ahora!&ensp;&middot;&ensp;${data.players.online} jugadores</p>`;
